...
public final class FileManager_Factory implements Factory<FileManager> {
  ...
  public static FileManager_Factory create(javax.inject.Provider<Context> contextProvider) {
    return new FileManager_Factory(Providers.asDaggerProvider(contextProvider));
  }
