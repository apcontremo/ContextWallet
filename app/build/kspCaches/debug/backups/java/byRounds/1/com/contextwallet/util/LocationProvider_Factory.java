...
public final class LocationProvider_Factory implements Factory<LocationProvider> {
  ...
  public static LocationProvider_Factory create(javax.inject.Provider<Context> contextProvider) {
    return new LocationProvider_Factory(Providers.asDaggerProvider(contextProvider));
  }
